...
5. **Prove it mechanically**: `python .kepler/scenarios/check.py intake --project <project>` — the wall that catches a missing fact, an unrouted row on a closed sheet, a dead PLAN route, or a `.gravity/bugs/` folder. Green before you report.
