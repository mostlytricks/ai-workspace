...
<!-- Per-project stencil for a running-app UI design system. Copy to <project>/DESIGN.md and fill.
     ...
     NOT the same as gravity/DESIGN.docs.md (the browser-read HTML-doc theme, generated by
     gravity/lib/doc_theme.py) — this file owns only the running app.
...
It owns *app visual design*; the browser-read HTML-doc theme is `gravity/lib/doc_theme.py`'s concern (explained in `gravity/DESIGN.docs.md`). One concern, one home.
-->
