...
<!-- Per-project stencil for a running-app UI design system. Copy to <project>/DESIGN.md and fill.
     ...
     NOT the same as the browser-read HTML-doc theme, generated by doc_theme.py
     (installed in this repo as .gravity/_lib/doc_theme.py; explained in the
     workspace's gravity/DESIGN.docs.md) — this file owns only the running app.
...
It owns *app visual design*; the browser-read HTML-doc theme is `doc_theme.py`'s concern (installed in this repo as `.gravity/_lib/doc_theme.py`; explained in the workspace's `gravity/DESIGN.docs.md`). One concern, one home.
-->
