...
A minimal `.gravity/` project used only as the **golden input** for the `/new-spec` golden-scenario (`.kepler/scenarios/new-spec/`). Not a real project — do not promote, junction, or build it.
