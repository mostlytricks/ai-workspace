...
A minimal `.gravity/` project used only as the **golden input** for the `/patch-slice` golden-scenario (`.kepler/scenarios/patch-slice/`). Not a real project — do not promote, junction, or build it.
