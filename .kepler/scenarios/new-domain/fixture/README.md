...
A minimal `.gravity/` project used only as the **golden input** for the `/new-domain` golden-scenario (`.kepler/scenarios/new-domain/`). Not a real project — do not promote, junction, or build it.
