...
Usage:
    python .kepler/scripts/scan_workspace.py             # compact JSON
    python .kepler/scripts/scan_workspace.py --pretty    # indented JSON
    python .kepler/scripts/scan_workspace.py --adoption-table
...
SCRIPT_DIR = Path(__file__).resolve().parent               # .kepler/scripts
WORKSPACE_ROOT = SCRIPT_DIR.parent.parent                  # ai-workspace/
sys.path.insert(0, str(WORKSPACE_ROOT / ".kepler" / "dashboard"))
