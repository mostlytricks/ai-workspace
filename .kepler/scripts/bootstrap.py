...
files, `gravity/`, and the `.claude/` + `.kepler/` tooling. Every tier folder is denied, and
...
Usage:
    python .kepler/scripts/bootstrap.py [--dry-run]
...
def main() -> int:
    ...
    sys.path.insert(0, str(WORKSPACE / ".kepler" / "dashboard"))
