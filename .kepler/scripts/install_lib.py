...
What never travels: the workspace half (`.kepler/scenarios/check.py`,
...
Usage:
    python .kepler/scripts/install_lib.py <project-or-alias> [--dry-run]
"""
...
def main(argv=None) -> int:
    ...
    if as_path.is_dir():
        ...
        sys.path.insert(0, str(WORKSPACE / ".kepler" / "scripts"))
