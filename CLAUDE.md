...
- **`DESIGN.md` vs `DESIGN.docs.md` — don't conflate:** the running *app's* visual identity vs the look of *browser-read docs*; a project may have both. UI projects only; skip for libraries, CLIs, scripts.
