...
│   ├── IMPLEMENTATION_PLAN.template.md  # Per-project "what/next" stencil (optional four-doc pipeline, §6). Two shapes: phase roadmap (arc projects) or slice queue (growing projects).
